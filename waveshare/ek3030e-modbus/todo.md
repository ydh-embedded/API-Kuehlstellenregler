...
## Print-Dashboard
- [x] print_dashboard.html: Tabellarische Registerübersicht mit Standardwerten und Änderungsmarkierung (grün)

## Navigation
- [x] Drucken-Link (print_dashboard.html) in Sidebar-Navigation hinzufügen
